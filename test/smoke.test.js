...
assert.strictEqual(packs.wind.releaseDate, '2009-03');
assert.strictEqual(packs.wind.releaseDatePrecision, 'month');
assert.strictEqual(packs.military.releaseDate, '2009-09-21');
assert.strictEqual(packs.military.releaseDatePrecision, 'day');
